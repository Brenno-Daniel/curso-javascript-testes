...
import { buildError, buildOrders, buildUser, buildOrder } from 'test/builders';
...
describe('Service > Orders', () => {
  ...
  it('should return a list of orders', async () => {
    ...
    expect(Order.findAll).toHaveBeenLastCalledWith({ where });
  ...
  it('should reject with an error when Order.findAll() fails', () => {
    ...
    jest.spyOn(Order, 'findAll').mockResolvedValueOnce(error);
