...
describe('Cart', () => {
  ...
  describe('special conditions', () => {
    ...
    it('should NOT apply percentage discount quantity is bellow or equals minimum', () => {
      const condition = {
        percentage: 30,
        minimum: 2,
      };
    ...
    it('should apply quantity discount foi odd quantities', () => {
      const condition = {
        quantity: 2,
      };
    ...
    it('should receive two or more conditions and determine/apply the best discount. First case.', () => {
      ...
      // in this case the best condition is the second
      const condition2 = {
        quantity: 2,
      };
    ...
    it('should receive two or more conditions and determine/apply the best discount. Second case.', () => {
      // in this case the best condition is the first
      const condition1 = {
        percentage: 80,
        minimum: 2,
      };
